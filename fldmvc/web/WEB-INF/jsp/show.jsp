    ...
    <div class="col-md-12 column">
      <form action="fldAction" method="post">
        ...
        <div class="form-group">
          ...
          <button type="button" class="btn btn-default" onclick="window.location.href='fldAction/insert'">insert</button>
          <button type="button" class="btn btn-default" style="float: right"  onclick="window.location.href='member/logout'">logout</button>
        </div>
      </form>
    </div>
    <div class="col-md-12 column">
