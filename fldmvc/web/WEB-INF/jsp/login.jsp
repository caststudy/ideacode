                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                if (res.indexOf("success") != -1) {
                                    $("#ts").html("登录成功,将转到首页......");
                                    setTimeout("window.location.href='${pageContext.servletContext.contextPath}/fldAction'", 2000);
                                } else {
                                    $("#ts").html("无效的用户和密码");
                                }
                            }
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="mempass"  value="888888" name="mempass" placeholder="用户密码......">
            </div>
